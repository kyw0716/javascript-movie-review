...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"Movies\": () => (/* binding */ Movies)\n/* harmony export */ });\nvar __classPrivateFieldSet = (undefined && undefined.__classPrivateFieldSet) || function (receiver, state, value, kind, f) {\r\n    if (kind === \"m\") throw new TypeError(\"Private method is not writable\");\r\n    if (kind === \"a\" && !f) throw new TypeError(\"Private accessor was defined without a setter\");\r\n    if (typeof state === \"function\" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError(\"Cannot write private member to an object whose class did not declare it\");\r\n    return (kind === \"a\" ? f.call(receiver, value) : f ? f.value = value : state.set(receiver, value)), value;\r\n};\r\nvar __classPrivateFieldGet = (undefined && undefined.__classPrivateFieldGet) || function (receiver, state, kind, f) {\r\n    if (kind === \"a\" && !f) throw new TypeError(\"Private accessor was defined without a getter\");\r\n    if (typeof state === \"function\" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError(\"Cannot read private member from an object whose class did not declare it\");\r\n    return kind === \"m\" ? f : kind === \"a\" ? f.call(receiver) : f ? f.value : state.get(receiver);\r\n};\r\nvar _Movies_list, _Movies_currentList;\r\nclass Movies {\r\n    constructor(list) {\r\n        _Movies_list.set(this, void 0);\r\n        _Movies_currentList.set(this, void 0);\r\n        const convertedList = this.convertResponseToMovieData(list);\r\n        __classPrivateFieldSet(this, _Movies_list, convertedList, \"f\");\r\n        __classPrivateFieldSet(this, _Movies_currentList, convertedList, \"f\");\r\n    }\r\n    getList() {\r\n        return [...__classPrivateFieldGet(this, _Movies_list, \"f\")];\r\n    }\r\n    getCurrentList() {\r\n        return [...__classPrivateFieldGet(this, _Movies_currentList, \"f\")];\r\n    }\r\n    add(list) {\r\n        const convertedList = this.convertResponseToMovieData(list);\r\n        __classPrivateFieldSet(this, _Movies_list, [...__classPrivateFieldGet(this, _Movies_list, \"f\"), ...convertedList], \"f\");\r\n        __classPrivateFieldSet(this, _Movies_currentList, convertedList, \"f\");\r\n    }\r\n    reset(list) {\r\n        const convertedList = this.convertResponseToMovieData(list);\r\n        __classPrivateFieldSet(this, _Movies_list, convertedList, \"f\");\r\n        __classPrivateFieldSet(this, _Movies_currentList, convertedList, \"f\");\r\n    }\r\n    convertResponseToMovieData(list) {\r\n        return list.map((data) => {\r\n            return {\r\n                id: data.id,\r\n                poster_path: data.poster_path,\r\n                title: data.title,\r\n                vote_average: data.vote_average,\r\n            };\r\n        });\r\n    }\r\n}\r\n_Movies_list = new WeakMap(), _Movies_currentList = new WeakMap();\r\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/domain/Movies.ts?");
